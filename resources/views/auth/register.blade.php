<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <x-input-label for="shop" :value="__('Shop Name')" />
            <x-text-input id="shop" class="block mt-1 w-full" type="text" name="shop" :value="old('shop')" required autofocus autocomplete="shop" />
