                    ...
                    @foreach ($companies as $company)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('storage/' . $company->image_path) }}" alt="Company Image" class="mr-3" style="max-height: 70px; max-width: 120px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('companies.update', $company->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="editCompanyImage{{ $company->id }}">Company Image:</label>
                                                <input type="file" class="form-control-file" id="editCompanyImage{{ $company->id }}" name="image">
                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('companies.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="addCompanyImage">Company Image:</label>
